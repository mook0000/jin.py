...
class Kiwoom(QAxWidget):
    ...
    def get_interest_stock(self):
        ...
        #count = 0
        #self.inter
        self.iw = pd.read_excel("C:/pythonfiles/lims/files/interest.xlsx",index_col=None,dtype={'종목코드':str,'종목명':str})
        #  키움증권 관심종목 1
    ...
    def trdata_slot(self,sScrNo,sRQName,sTrCode,sRecordName,sPrevNext):
        ...
        if sRQName == "예수금상세현황요청":
            ...
            for i in range(cnt):
                ...
                #data.append(self.run_codenm)      # 코드명 삭제 --> 위 컬럼명 조정
